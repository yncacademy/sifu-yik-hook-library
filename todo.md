...
- [x] Prepare the enriched 1,000-hook dataset for static client-side search and filtering.
- [x] Build the dark-green Sifu Yik editorial layout, including the hook-list and detail-pane experience.
